...
import { fetchDashboardData }   from '@/app/admin/dashboard/fetcher';

import { PageHeader }           from '@/app/admin/dashboard/sections/PageHeader';
import { KpiStrip }             from '@/app/admin/dashboard/sections/KpiStrip';
import { StatusOverviewRow }    from '@/app/admin/dashboard/sections/StatusOverviewRow';
import { PortGrid }             from '@/app/admin/dashboard/sections/PortGrid';
import { SecurityRow }          from '@/app/admin/dashboard/sections/SecurityRow';
import { LoadCurves }           from '@/app/admin/dashboard/sections/LoadCurves';
import { UserCurves }           from '@/app/admin/dashboard/sections/UserCurves';
...
export default async function AdminDashboardPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <PageHeader uptimePct={uptimePct} portsTotal={portsTotal} />
