...
export function KpiCard({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          // Drop the Orbitron heading face for the actual number — its
          // stylistic slashed zero is so close to an 8 that operators
          // mis-read uptime / blocked-attempts at a glance. System sans
          // gives an unambiguous 0 with crisp digit shapes; we keep the
          // label above in Orbitron so the "futuristic dashboard" feel
          // survives.
          ...
          // tnum = tabular numbers (every digit same width, prevents the
          // KPI value from jiggling left/right as it animates).
          // lnum = lining numbers (no descenders that drop below baseline).
