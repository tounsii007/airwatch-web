...
import { bearingDeg, elevationAngleDeg } from '@/app/ar/arMath';
import { projectToScreen, type DeviceOrientation, type ScreenPoint, type Viewport } from '@/app/ar/arProjection';
